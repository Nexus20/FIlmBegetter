...
} from "../../../../../shared/components/add-into-collection-dialog/add-into-collection-dialog.component";
...
export class MovieViewComponent implements OnInit, OnDestroy {
    ...
    public addToCollectionButtonConfig: IButton = {
        disabled: false, size: 'default', text: "Collections", type: 'default'
    }
    ...
    openDialog(event: any, state: boolean) {
        event.preventDefault();
        this.dialog.open(AddIntoCollectionDialogComponent, { state, movieId: this.movie.id });
    }
